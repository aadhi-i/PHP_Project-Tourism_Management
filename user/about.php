...
<div class="row">
	<div class="my-bio cwp4-text col-lg-6">
			...
			<a href="index.php" class="action-button btn mt-4">Read more <span class="fa fa-angle-double-right"></span></a>
	</div>
<div class="col-lg-6 ">
		...
		<div class="container">
			<div class="row text-center">
					<div class="col-lg-3 col-md-6 col-sm-6 column">
						<a href="#url"><img class="img img-responsive" src="assets/images/messi.jpg" alt=""></a>
						<h4><a href="#url">Lionel Messi</a></h4>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 column">
							<a href="#url"><img class="img img-responsive" src="assets/images/neymar.jpg" alt=""></a>
							<h4><a href="#url">Neymar Jr.</a></h4>
								<div class="w3l-team-7_bottom">
									<div class="w3l-team-7_bottom-left">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 column">
						<a href="#url"><img class="img img-responsive" src="assets/images/ronaldo.webp" alt=""></a>
						<h4><a href="#url">Cristiano Ronaldo</a></h4>
							<div class="w3l-team-7_bottom">
								<div class="w3l-team-7_bottom-left">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 column">
						<a href="#url"><img class="img img-responsive" src="assets/images/suarez.webp" alt=""></a>
						<h4><a href="#url">Luis Suarez</a></h4>
							<div class="w3l-team-7_bottom">
								<div class="w3l-team-7_bottom-left">
									<h6>Manager of company</h6>
								</div>
