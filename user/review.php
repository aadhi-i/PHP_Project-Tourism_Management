    ...
    <div class="about-inner contact">
        <div class="breadcrumbs-sub">
            <ul class="breadcrumbs-custom-path">
                <li class="right-side propClone"><a href="bookings.php" class="editContent">Bookings <span class="fa fa-angle-right" aria-hidden="true"></span></a> <p></li>
...
<section class="w3l-contact-info-main" id="contact">
    ...
    <div class="contact-sec	editContent">
        ...
        <?php
          ...
          $q1="select * from packages where package_id='$package_id'";
          $rs1=mysqli_query($con,$q1)or die("Wrong Query");
          $row1=mysqli_fetch_assoc($rs1);

          $uid=$_SESSION['uid'];
          $q2="select * from users where uid='$uid'";
          $rs2=mysqli_query($con,$q2)or die("Wrong Query");
          $row2=mysqli_fetch_assoc($rs2);
        
        ?>
    <div class="map-content-9 mb-5 ">
              <?php
                echo "<form action='review_pro.php?bid=$book_id' method='post'>";
              ?>
            <div class="twice-two">
                <input type="text" class="form-control "  id="w3lName" value="<?php echo $row2['username'];?>" disabled>
                <input type="email" class="form-control"  id="w3lSender" value="<?php echo $row1['title'];?>" disabled>
                <input type="number" class="form-control" name="rate" id="w3lSubject" min="1" max="5" placeholder="Rate our Package : 1 - 5" required="">
            </div><br>
            <textarea name="review" class="form-control" id="w3lMessage" placeholder="Write your review" required=""></textarea>

            <div class="text-right">
             
                <button type="submit" class="btn btn-contact">Submit Review</button>
            </div>
        </form>
    </div>
